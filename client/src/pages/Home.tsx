    ...
    <div className="min-h-screen w-full relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#0a0f1e] to-black">
      ...
      <main className="relative z-10 container mx-auto px-4 py-12 flex flex-col gap-16">
        ...
        <div className="text-center space-y-4 relative">
          <svg 
            className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-auto pointer-events-none z-0"
          ...
          <h1 className="relative z-10 text-6xl md:text-8xl font-display text-transparent bg-clip-text bg-gradient-to-b from-white via-blue-100 to-blue-300 drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
            Reindeer Runner
          </h1>
          <p className="relative z-10 text-lg md:text-xl text-blue-200/80 font-light max-w-2xl mx-auto">
